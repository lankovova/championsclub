...
class SeaLight extends Game {
    ...
    public static $paytable = [
        ...
        [0,2,25,125,750],    //PAYTABLE FOR SYMBOL 6
        [0,0,5,25,100],     //PAYTABLE FOR SYMBOL 7
        [0,10,250,2500,9000],     //PAYTABLE FOR SYMBOL 8
        [0,0,10,50,125],     //PAYTABLE FOR SYMBOL 9
        [0,2,25,125,750],     //PAYTABLE FOR SYMBOL 10
        [0,0,5,25,100],     //PAYTABLE FOR SYMBOL 11
        [0,2,5,20,500],     //PAYTABLE FOR SYMBOL 12
        [0,0,15,75,250]     //PAYTABLE FOR SYMBOL 13
    ];

...
class KingOfJewels extends Game {
    ...
    public static $paytable = [
        [0,0,15,50,200], //PAYTABLE FOR SYMBOL 0
        [0,0,50,500,5000],  //PAYTABLE FOR SYMBOL 1
        [0,0,30,150,500],  //PAYTABLE FOR SYMBOL 2
        [0,0,2,10,50],  //PAYTABLE FOR SYMBOL 3 (Scatter)
        [0,0,30,150,500],    //PAYTABLE FOR SYMBOL 4
        [0,0,10,25,150],    //PAYTABLE FOR SYMBOL 5
        [0,0,10,25,150],     //PAYTABLE FOR SYMBOL 6
        [0,0,15,50,200]    //PAYTABLE FOR SYMBOL 7
    ];

...
class ComputerWorldOld extends Game {
    ...
    public static $paytable = [
        [0,0,5,25,100], //PAYTABLE FOR SYMBOL 0
        [0,0,5,40,150],  //PAYTABLE FOR SYMBOL 1
        [0,5,40,400,2000],  //PAYTABLE FOR SYMBOL 2
        [0,10,100,1000,5000],  //PAYTABLE FOR SYMBOL 3
        [0,0,5,25,100],    //PAYTABLE FOR SYMBOL 4
        [0,0,5,40,150],    //PAYTABLE FOR SYMBOL 5
        [0,0,3,30,300],     //PAYTABLE FOR SYMBOL 6
        [0,5,30,100,750],     //PAYTABLE FOR SYMBOL 7
        [0,5,30,100,750],     //PAYTABLE FOR SYMBOL 8
        [0,0,5,25,100]     //PAYTABLE FOR SYMBOL 9
    ];

...
class Robinson extends Game {
    ...
    public static $paytable = [
        ...
        [0,5,50,300,1000],  //PAYTABLE FOR SYMBOL 3
        [0,10,300,3000,10000],  //PAYTABLE FOR SYMBOL 4
        [0,0,5,20,100],    //PAYTABLE FOR SYMBOL 5
        [0,0,10,50,100],    //PAYTABLE FOR SYMBOL 6
        [0,0,25,200,800],     //PAYTABLE FOR SYMBOL 7
        [0,0,15,75,400],     //PAYTABLE FOR SYMBOL 8
        [0,2,5,20,500],     //PAYTABLE FOR SYMBOL 9
        [0,0,20,100,600],     //PAYTABLE FOR SYMBOL 10

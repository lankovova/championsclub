...
class SavannaQueen extends Game {
    ...
    public static $paytable = [
        ...
        [0,2,25,125,750],  //PAYTABLE FOR SYMBOL 4
        [0,2,25,125,750],    //PAYTABLE FOR SYMBOL 5
        [0,0,5,25,100],    //PAYTABLE FOR SYMBOL 6
        [0,10,250,2500,9000],     //PAYTABLE FOR SYMBOL 7
        [0,0,10,50,125],     //PAYTABLE FOR SYMBOL 8
        ...
        [0,2,5,20,500]    //PAYTABLE FOR SYMBOL 13
    ];

...
class FireRagePlus extends Game {
    ...
    public static $paytable = [
       [0,0,5,20,100], //PAYTABLE FOR SYMBOL 1
        ...
        [0,0,10,40,150],  //PAYTABLE FOR SYMBOL 4
        [0,5,25,100,500],    //PAYTABLE FOR SYMBOL 5
        [0,5,50,200,1000],    //PAYTABLE FOR SYMBOL 6
        [0,0,0,0,0],     //PAYTABLE FOR SYMBOL 7
        [0,0,0,0,0],     //PAYTABLE FOR SYMBOL 8
        [0,0,0,0,0],     //PAYTABLE FOR SYMBOL 9
        [0,0,10,40,150],     //PAYTABLE FOR SYMBOL 10
        [0,5,15,75,250],     //PAYTABLE FOR SYMBOL 11
        [0,10,100,1000,5000]     //PAYTABLE FOR SYMBOL 12
    ];

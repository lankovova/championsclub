...
class PepperSeven extends Game {
    ...
    public static $paytable = [
        [0,5,30,100,750], //PAYTABLE FOR SYMBOL 1
        [0,0,5,40,150],  //PAYTABLE FOR SYMBOL 2
        [0,0,5,40,150],  //PAYTABLE FOR SYMBOL 3
        [0,10,100,1000,5000],  //PAYTABLE FOR SYMBOL 4
        [0,5,40,400,2000],    //PAYTABLE FOR SYMBOL 5
        ...
        [0,5,30,100,750]    //PAYTABLE FOR SYMBOL 10
    ];

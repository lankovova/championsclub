...
@section('css')
    <link href="{{asset('public/css/computerworldold.css')}}" rel=stylesheet type=text/css>
@endsection
...
@section('js')
    @parent
    <script src="{{asset('public/js/computerworldold_settings.js')}}"></script>
    <script src="{{asset('public/js/game.js')}}"></script>
    <script>
        var game = new divSlot.Game('ComputerWorldOld');
    </script>
@endsection
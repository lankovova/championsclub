...
var isBuffer = __webpack_require__(375);
...
var _Button2 = __webpack_require__(47);
...
var MultipleStatesButton = function (_Button) {
    _inherits(MultipleStatesButton, _Button);

    function MultipleStatesButton(props) {
        _classCallCheck(this, MultipleStatesButton);

        return _possibleConstructorReturn(this, (MultipleStatesButton.__proto__ || Object.getPrototypeOf(MultipleStatesButton)).call(this, props));
    }
    ...
    _createClass(MultipleStatesButton, [{
        ...
        key: '_handleDisabling',
        value: function _handleDisabling() {
            ...
            try {
                for (var _iterator2 = Object.keys(this.state)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var stateKey = _step2.value;
...
exports.default = MultipleStatesButton;
...
var GambleModalButton = function (_Button) {
    _inherits(GambleModalButton, _Button);

    function GambleModalButton(props) {
        _classCallCheck(this, GambleModalButton);

        var _this = _possibleConstructorReturn(this, (GambleModalButton.__proto__ || Object.getPrototypeOf(GambleModalButton)).call(this, props));

        _this.overlayColor = props.overlayColor;
        return _this;
    }

    _createClass(GambleModalButton, [{
        key: '_initEffects',
        value: function _initEffects() {
            var self = this;
            this.node.onmouseenter = function () {
    ...
    return GambleModalButton;
}(_Button3.default);

exports.default = GambleModalButton;
...
var ToggleBlock = function () {
    function ToggleBlock(options, props) {
    ...
    _createClass(ToggleBlock, [{
        ...
        value: function init(options) {
            ...
            var blockContent = this.node.querySelector('.content');

            var reversedItems = options.items.slice().reverse();

            // Fill block content with appropriate items
            reversedItems.forEach(function (value) {
        ...
        value: function _initListeners() {
            ...
            this.node.addEventListener(_events.transitionEnd, function (event) {
                if (_this2.isToggled) {
                    ...
                    _this2.props.setSpinPossibility();
                }
            });
        }
    }, {
        key: 'highlightItem',
        value: function highlightItem(itemValue) {
            var _this3 = this;
...
var btoa = (typeof window !== 'undefined' && window.btoa && window.btoa.bind(window)) || __webpack_require__(383);
...
module.exports = function xhrAdapter(config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if (utils.isStandardBrowserEnv()) {
      var cookies = __webpack_require__(384);
...
var Game = function () {
    function Game(gameName) {
        ...
        this.setDenomination = function (newDenom) {
            return _this.setBetRelatedValue(settings.denominations, _this.pointsController.denomination, _this.pointsController.setDenomination)(newDenom);
        };

        this.setBetRelatedValue = function (array, currentValue, setNewValue) {
            return function (value) {
                var newValue = value ? +value : (0, _arrayHelp.getNextArrayItem)(array, currentValue);
        ...
        this.setLines = function (newLines) {
            var newValue = newLines ? +newLines : (0, _arrayHelp.getNextArrayItem)(settings.lines, _this.pointsController.lines);
            _this.pointsController.setLines(newValue);

            _this.setSpinPossibility();

            _this.linesController.showAndHideLines(newValue);
        };
        ...
        this.setSpinPossibility = function () {
            if (_this.pointsController.totalBet > _this.pointsController.userCashInPoints) {
                ...
                _this.interfaceController.panel.notifier.text = 'Game over, place your bet';
                ...
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        ...
                        case 5:
                            ...
                            // FIXME:
                            if (_this.interfaceController.gambleModal.isOn) {
                                _this.interfaceController.gambleOver();
                            }
        ...
        this.startGamble = function () {
            _this.linesController.unblurAllSymbols();
            _this.linesController.stopCyclingWinningLines();
            ...
            _this.interfaceController.setGamble(_this.pointsController.userWin);
        };
        ...
        this.getDataAndSpin = function () {
            ...
            if (_this.autoSpinIsOn) _this.interfaceController.enableAuto();
            ...
            _this.getSpinResponse().then(function (result) {
                ...
                _this.startReels(_this.spinResponse.final_symbols);
            });
        };

        this.autoSpin = function () {
            // If no auto spin, turn it on
            if (!_this.autoSpinIsOn) _this.autoSpinIsOn = true;

            // Start normal spin
            _this.getDataAndSpin();
        };

        this.stopAutoSpinning = function () {
            _this.autoSpinIsOn = false;
        };
        ...
        this.bonusSpin = function () {
            ...
            _this.interfaceController.panel.notifier.text = 'Free spin ' + _this.bonusSpins.currentSpinIndex + ' of ' + _this.bonusSpins.totalSpins;

            // Spin reels to given final symbols
            _this.startReels(_this.bonusSpins.spins[_this.bonusSpins.currentSpinIndex - 1].final_symbols);
        };
                ...
                while (1) {
                    switch (_context7.prev = _context7.next) {
                        ...
                        case 2:
                            ...
                            _this.pointsController = new _PointsController2.default({
                                panel: _this.interfaceController.panel,
                                linePresenters: _this.interfaceController.linePresenters,
                                linesBlock: _this.interfaceController.linesBlock,
                                betPerLineBlock: _this.interfaceController.betPerLineBlock,
                                denominationBlock: _this.interfaceController.denominationBlock
                            }, {
                                userCash: userCash,
                                denomination: 0.01,
                                lines: 1,
    ...
    _createClass(Game, [{
         ...
         */
        value: function startReels(finalSymbols) {
            // Hide all lines
...
function getNextArrayItem(array, item) {
    ...
    var newIndex = currentIndex === array.length - 1 ? 0 : currentIndex + 1;
...
var PointsController = function () {
    function PointsController(props, options) {
        ...
        this.setDenomination = function (denomination) {
            _this._denomination = denomination;

            _this.props.denominationBlock.highlightItem(denomination);
        ...
        this.setLines = function (linesAmount) {
            _this._linesAmount = linesAmount;

            _this.props.linesBlock.highlightItem(linesAmount);

            // Update panel value
            _this.props.panel.setLinesAmount(_this._linesAmount);

            // Update line presenters text
            _this.props.linePresenters.setText(_this._linesAmount, _this._betPerLine);

            _this._updateTotalBet();
        };

        this.setBetPerLine = function (betPerLine) {
            _this._betPerLine = betPerLine;

            _this.props.betPerLineBlock.highlightItem(betPerLine);

            // Update panel value
            _this.props.panel.setBetPerLine(_this._betPerLine);
    ...
    _createClass(PointsController, [{
        ...
        value: function _init(_ref) {
            var _ref$lines = _ref.lines,
                lines = _ref$lines === undefined ? settings.lines[0] : _ref$lines,
                _ref$betPerLine = _ref.betPerLine,
                betPerLine = _ref$betPerLine === undefined ? settings.betPerLine[0] : _ref$betPerLine,
                _ref$denomination = _ref.denomination,
                denomination = _ref$denomination === undefined ? settings.denominations[0] : _ref$denomination,
                _ref$userCash = _ref.userCash,
                userCash = _ref$userCash === undefined ? 0 : _ref$userCash,
                _ref$userWin = _ref.userWin,
                userWin = _ref$userWin === undefined ? 0 : _ref$userWin;
        ...
        key: "coinsToPoints",
        value: function coinsToPoints(coins) {
            return Math.floor(coins / (this._denomination * 100));
        }
    }, {
        key: "kupsToPoints",
        value: function kupsToPoints(kups) {
            return Math.floor(kups / this._denomination);
        }
    }, {
        key: "kupsToCoins",
        value: function kupsToCoins(kups) {
            return kups * 100;
        }
    }, {
        key: "coinsToKups",
        value: function coinsToKups(coins) {
            return coins / 100;
        }
    }, {
        key: "pointsToCoins",
        value: function pointsToCoins(points) {
...
var _ReelPicker = __webpack_require__(349);
...
var ReelsContorller = function () {
    ...
    function ReelsContorller(containerNode, props) {
        ...
        this.onReelStop = function (reelIndex) {
            stoppedReelsCounter++;

            // Check if last reel has stopped
            if (stoppedReelsCounter === _this.reels.length) {
                // Set previous delay betwwen reels spin start
                _this.shouldStopReels = false;
    ...
    _createClass(ReelsContorller, [{
        ...
        value: function _initReels() {
            var reelsContainer = document.createElement('div');
        ...
        key: 'startReels',
        value: function startReels(finalSymbolsMap) {
        ...
        key: 'spinReels',
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(finalSymbolsMap) {
                var i, finalSymbols;
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 1:
                                ...
                                finalSymbols = this.getReelSymbolsFromSymbolsMap(finalSymbolsMap, i);

                                // Wait previous reel to resolve before spinning next

                                _context.next = 5;
                                return this.spinReel(this.reels[i], finalSymbols);
        ...
        key: 'spinFallReels',
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(finalSymbolsMap) {
                var i, finalSymbols, _i;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                return function () {
                                    return new Promise(function (resolve) {
                                        return setTimeout(resolve, settings.delayBeforeStartReelsSpin);
                                    });
                                }();
                            ...
                            case 4:
                                if (!(_i < this.reels.length)) {
                                    _context2.next = 10;
                                    break;
                                }

                                _context2.next = 7;
                                return this.spinReel(this.reels[_i]);
            ...
            function spinFallReels(_x2) {
                return _ref2.apply(this, arguments);
            }

            return spinFallReels;
        }()
        ...
        key: 'spinReel',
        value: function spinReel(reel, finalSymbols) {
            var _this2 = this;
        ...
        key: 'getReelSymbolsFromSymbolsMap',
        value: function getReelSymbolsFromSymbolsMap(symbolsMap, reelIndex) {
            var resultArray = [];

            for (var i = 0; i < symbolsMap.length; i++) {
...
var _SpinReel = __webpack_require__(350);

var _SpinReel2 = _interopRequireDefault(_SpinReel);

var _FallReel = __webpack_require__(351);

var _FallReel2 = _interopRequireDefault(_FallReel);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var exportedReel = settings.animationType === 'fall' ? _FallReel2.default : _SpinReel2.default;
...
var _Symbol2 = __webpack_require__(130);
...
var Reel = function () {
     ...
     */
    function Reel(reelIndex, onStop) {
    ...
    _createClass(Reel, [{
        ...
        value: function _init() {
            ...
            var reelWrapperNode = document.createElement('div');
        ...
        value: function _initListeners() {
            ...
            this.reelNode.addEventListener(_events.transitionEnd, function () {
                // Reset reel symbols
                _this.resetReel();

                _this.props.onStop(_this.reelIndex);
            });
        }
        ...
        key: 'spin',
        value: function spin(finalSymbols) {
        ...
        key: 'addFinalSymbols',
        value: function addFinalSymbols(finalSymbolsMap) {
            var finalSymbols = [];

            for (var i = 0; i < finalSymbolsMap.length; i++) {
                finalSymbols.push(new _Symbol3.default(finalSymbolsMap[i]));
            }
        ...
        key: 'addSymbols',
        value: function addSymbols(symbolsArr) {
            for (var i = symbolsArr.length - 1; i >= 0; i--) {
...
var _SymbolFallAnimation = __webpack_require__(352);
...
var FallReel = function () {
    /**
     * Create reel with starting symbols in it
     * @param {Number} reelIndex Index of reel in Game
     * @param {Function} onStop Function to call when reel has stopped
     */
    function FallReel(reelIndex, onStop) {
        var _this = this;

        _classCallCheck(this, FallReel);

        this._symbolHasFelled = function (symbolIndexInReel) {
    ...
    _createClass(FallReel, [{
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 1:
                                if (!(i < this.finalSymbols.length)) {
                                    _context.next = 7;
                                    break;
                                }

                                _context.next = 4;
                                return this.finalSymbols[i].fall(i);
        ...
        key: 'removeOldSymbols',
        value: function removeOldSymbols() {
        ...
        value: function addFinalSymbols(finalSymbolsMap) {
            ...
            for (var i = 0; i < finalSymbolsMap.length; i++) {
                finalSymbols.push(new _SymbolFallAnimation2.default(finalSymbolsMap[i], { symbolHasFelled: this._symbolHasFelled }));
            }
        ...
        key: '_addSymbols',
        value: function _addSymbols(symbolsArr) {
...
var _Symbol3 = __webpack_require__(130);
...
var SymbolFallAnimation = function (_Symbol2) {
    _inherits(SymbolFallAnimation, _Symbol2);

    function SymbolFallAnimation(symbolNumber, props) {
        _classCallCheck(this, SymbolFallAnimation);

        var _this = _possibleConstructorReturn(this, (SymbolFallAnimation.__proto__ || Object.getPrototypeOf(SymbolFallAnimation)).call(this, symbolNumber));
    ...
    _createClass(SymbolFallAnimation, [{
        key: "initSymbol",
        value: function initSymbol() {
            _get(SymbolFallAnimation.prototype.__proto__ || Object.getPrototypeOf(SymbolFallAnimation.prototype), "initSymbol", this).call(this);
        ...
        value: function initListeners() {
            ...
            this.node.addEventListener(_events.transitionEnd, function () {
                _this2.props.symbolHasFelled(_this2.indexInReel);
            });
        }
    }, {
        key: "fall",
        value: function fall(indexInReel) {
            var _this3 = this;

            // Next symbol fall faster than previous
            return new Promise(function (resolve) {
                _this3.indexInReel = indexInReel;
                _this3.symbolNode.style.transition = "transform " + 1000 / 6 * (settings.numOfRows - _this3.indexInReel) + "ms " + settings.fallAnimTimingFunc;
                _this3.symbolNode.style.transform = "translateY(" + (settings.numOfRows - _this3.indexInReel) * settings.symbolSize + "px)";
...
var _Line = __webpack_require__(354);
...
var showHideLinesTimeoutId = void 0;
...
var LinesController = function () {
    ...
    _createClass(LinesController, [{
        key: 'createWinningLines',
        value: function createWinningLines(gameResult) {
            var winningLines = [];
            ...
            try {
                for (var _iterator = gameResult[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var res = _step.value;

                    var lineColor = this._getLineColorBasedOnItsIndex(res.line_index);
                    var line = new _Line2.default(this.gameWrapperNode, lineColor, res.line_index, res.points, this.props.reels);
                    ...
                    try {
                        for (var _iterator2 = res.list[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            var sCoor = _step2.value;

                            // Get reel
                            var reel = this.props.reels[sCoor.col];
                            // Get winning symbol
                            var symbol = reel.finalSymbols[reel.finalSymbols.length - sCoor.row - 1];
                    ...
                    try {
                        for (var _iterator3 = highlightedSymbols[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                            var _symbol = _step3.value;

                            _symbol.highlighted = false;
                        }
                    } catch (err) {
        ...
        key: 'blurAllSymbols',
        value: function blurAllSymbols() {
            this.props.reels.forEach(function (reel) {
                reel.finalSymbols.forEach(function (symbol) {
                    return symbol.blurDark();
                });
            });
        }
        ...
        key: 'unblurAllSymbols',
        value: function unblurAllSymbols() {
            this.props.reels.forEach(function (reel) {
                reel.finalSymbols.forEach(function (symbol) {
                    return symbol.unblur();
                });
            });
        }
        ...
        key: 'stopCyclingWinningLines',
        value: function stopCyclingWinningLines() {
        ...
        value: function () {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                if (!this.cycleWinningLines) {
                                    _context.next = 8;
                                    break;
                                }

                                line = this.winningLines[iterator++ % this.winningLines.length];
                                _context.next = 6;
            ...
            function cycleShowingWinningLines() {
                return _ref.apply(this, arguments);
            }

            return cycleShowingWinningLines;
        }()
        ...
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(gameResult, addUserWin) {
                var _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, line;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                _context2.prev = 5;
                                _iterator4 = this.winningLines[Symbol.iterator]();
        ...
        key: 'showAndHideLines',
        value: function showAndHideLines(linesAmount) {
            var _this = this;
            ...
            if (typeof showHideLinesTimeoutId !== 'undefined') clearTimeout(showHideLinesTimeoutId);
            ...
            // Hide after delay
            showHideLinesTimeoutId = setTimeout(function () {
                for (var _i = 0; _i < linesAmount; _i++) {
                    _this.lines[_i].hide();
                }
            }, 1000);
        }
        ...
        key: 'showLineByNumber',
        value: function showLineByNumber(lineIndex) {
        ...
        key: '_createStaticLines',
        value: function _createStaticLines() {
            for (var i = 0; i < settings.lineTypes.length; i++) {
                var lineColor = this._getLineColorBasedOnItsIndex(i);

                var line = new _Line2.default(this.gameWrapperNode, lineColor, i, 0, this.props.reels);
                line.connectHighlites();
        ...
        key: '_getLineColorBasedOnItsIndex',
        value: function _getLineColorBasedOnItsIndex(lineIndex) {
            var presenterArr = lineIndex < 10 ? settings.linePresenterLeftLines : settings.linePresenterRightLines;
            ...
            try {
                for (var _iterator6 = presenterArr[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                    var presenter = _step6.value;

                    if (presenter.lineIndex === lineIndex) return presenter.color;
                }
            } catch (err) {
...
var Line = function () {
     ...
     */
    function Line(containerNode, strokeColor, lineTypeNumber, points, reels) {
    ...
    _createClass(Line, [{
        ...
        key: "_lineWidth",
        value: function _lineWidth() {
            return this.container.offsetWidth;
        }
    }, {
        key: "_lineHeight",
        value: function _lineHeight() {
...
var _LinePresenters = __webpack_require__(356);
...
var _ToggleBlock = __webpack_require__(133);

var _ToggleBlock2 = _interopRequireDefault(_ToggleBlock);

var _ToggleLanguageBlock = __webpack_require__(369);

var _ToggleLanguageBlock2 = _interopRequireDefault(_ToggleLanguageBlock);

var _Alert = __webpack_require__(370);

var _Alert2 = _interopRequireDefault(_Alert);

var _GambleModal = __webpack_require__(371);
...
var InterfaceController = function () {
    function InterfaceController(props) {
        ...
        this.spinStopTake = function () {
            if (_this.panel.btns.SST.state.spin) {
                _this.props.spinReels();
            } else if (_this.panel.btns.SST.state.stop) {
                _this.props.stopReels();
            } else if (_this.panel.btns.SST.state.takeWin) {
                _this.props.takeWin();
            } else if (_this.panel.btns.SST.state.speedUpTakeWin) {
                _this.props.speedUpTakeWin();
            }
        };

        this.autoSpinClick = function () {
            if (_this.panel.btns.auto.state) {
                if (!_this.panel.btns.auto.isOn) {
                    _this.props.autoSpin();
                } else {
                    _this.props.stopAutoSpinning();
                }
                _this.panel.btns.auto.isOn = !_this.panel.btns.auto.isOn;
            }
        };
        ...
        this.maxBetClickHandler = function () {
            ...
            } else if (_this.panel.btns.maxBet.state.black) {
                _this.pickSuit('black')();
            }
        };

        this.gambleClick = function () {
            if (_this.panel.btns.gamble.state.gamble) {
                _this.props.startGamble();
            } else if (_this.panel.btns.gamble.state.red) {
                _this.pickSuit('red')();
            }
        };
        ...
        this.enableSpin = function () {
            return _this.panel.btns.SST.enable('spin');
        };

        this.disableSpin = function () {
            return _this.panel.btns.SST.state.spin = false;
        };

        this.enableGamble = function () {
            return _this.panel.btns.gamble.enable('gamble');
        };

        this.enableAuto = function () {
            return _this.panel.btns.auto.state = true;
        };

        this.disableAuto = function () {
            return _this.panel.btns.auto.state = false;
        };

        this.disablePanelGambleBtns = function () {
            _this.panel.btns.gamble.disable();
            _this.panel.btns.maxBet.disable();
        };

        this.enablePanelGambleBtns = function () {
            _this.panel.btns.gamble.enable('red');
            _this.panel.btns.maxBet.enable('black');
        };
        ...
        this.enableStop = function () {
            return _this.panel.btns.SST.enable('stop');
        };

        this.disableStop = function () {
            return _this.panel.btns.SST.state.stop = false;
        };

        this.enableTakeWin = function () {
            return _this.panel.btns.SST.enable('takeWin');
        };

        this.disableTakeWin = function () {
            return _this.panel.btns.SST.state.takeWin = false;
        };

        this.enableSpeedUpTransferWin = function () {
            return _this.panel.btns.SST.enable('speedUpTakeWin');
        };

        this.disableSpeedUpTransferWin = function () {
            return _this.panel.btns.SST.state.speedUpTakeWin = false;
        };

        this.enableLines = function () {
            return _this.panel.btns.lines.enable();
        };

        this.enableBetPerLines = function () {
            return _this.panel.btns.betPerLine.enable();
        };

        this.enableDenomination = function () {
            return _this.panel.btns.denomination.enable();
        };

        this.enableLanguage = function () {
            return _this.panel.btns.language.enable();
        };

        this.setIdle = function () {
            _this.enableInterface();

            _this.panel.btns.gamble.disable();
            _this.panel.btns.SST.enable('spin');
            _this.panel.btns.maxBet.enable('maxbet');
        };

        this.setTakeWin = function () {
        ...
        this.gambleReadyToPick = function () {
            ...
            _this.enablePanelGambleBtns();

            // Enable take win posibillity
            _this.enableTakeWin();

            _this.panel.notifier.text = 'Choose red or black or take win';
        };

        this.gambleOver = function () {
            _this.gambleModal.hide();
            _this.setIdle();

            _this.panel.notifier.text = 'Game over - gamble completed, place your bet';
        };

        this.pickSuit = function (suit) {
            return function () {
                console.log(suit);
                if (_this.gambleModal.btns[suit].state) {
                    // Disable take btn
                    _this.disableTakeWin();

                    _this.gambleModal.pickCard(suit);
                }
            };
        };

        this.disableInterface = function () {
            Object.keys(_this.panel.btns).forEach(function (btnKey) {
                return _this.panel.btns[btnKey].disable();
            });
        };
    ...
    _createClass(InterfaceController, [{
        ...
        value: function enableInterface() {
            var _this2 = this;

            Object.keys(this.panel.btns).forEach(function (btnKey) {
                return _this2.panel.btns[btnKey].enable();
            });
        }
    }, {
        ...
        value: function _initTogglingBlocks() {
            ...
            this.denominationBlock = new _ToggleBlock2.default({
                ...
                items: settings.denominations.map(function (item) {
...
var _LinePresenter = __webpack_require__(357);
...
var LinePresenters = function () {
    function LinePresenters(_ref) {
        var _this = this;

        var lines = _ref.lines,
            containerNode = _ref.containerNode;

        _classCallCheck(this, LinePresenters);

        this.setText = function (linesAmount, betPerLine) {
            _this.linePresenters.forEach(function (presenter) {
                presenter.text = presenter.line.lineTypeNumber < linesAmount ? betPerLine : '';
            });
        };
    ...
    _createClass(LinePresenters, [{
        ...
        value: function _init() {
            ...
            try {
                for (var _iterator = settings.linePresenterLeftLines[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var presenterInfo = _step.value;

                    var presenter = new _LinePresenter2.default(this.lines[presenterInfo.lineIndex], presenterInfo.color);
            ...
            try {
                for (var _iterator2 = settings.linePresenterRightLines[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var _presenterInfo = _step2.value;

                    var _presenter = new _LinePresenter2.default(this.lines[_presenterInfo.lineIndex], _presenterInfo.color);
                    pRight.appendChild(_presenter.node);
                    this.linePresenters.push(_presenter);
                }
            } catch (err) {
                _didIteratorError2 = true;
                _iteratorError2 = err;
...
var LinePresenter = function () {
    function LinePresenter(line, color) {
        var _this = this;
...
var _Notifier = __webpack_require__(359);

var _Notifier2 = _interopRequireDefault(_Notifier);

var _JackpotBonus = __webpack_require__(360);

var _JackpotBonus2 = _interopRequireDefault(_JackpotBonus);

var _TNWinBlock = __webpack_require__(361);

var _TNWinBlock2 = _interopRequireDefault(_TNWinBlock);

var _buttons = __webpack_require__(362);

var Buttons = _interopRequireWildcard(_buttons);

var _TNBlock = __webpack_require__(131);
...
var Panel = function () {
    function Panel(node, props) {
        ...
        this.jb = new _JackpotBonus2.default(document.querySelector('#jackpotNumber'), document.querySelector('#bonusNumber'), { jValue: 7765.90, bValue: 6403.83 });
...
var _TNBlock2 = __webpack_require__(131);
...
var _ButtonWithNumber = __webpack_require__(363);

Object.defineProperty(exports, 'ButtonWithNumber', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_ButtonWithNumber).default;
  }
});

var _GambleModalButton = __webpack_require__(132);

Object.defineProperty(exports, 'GambleModalButton', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_GambleModalButton).default;
  }
});

var _MultipleStatesButton = __webpack_require__(65);

Object.defineProperty(exports, 'MultipleStatesButton', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_MultipleStatesButton).default;
  }
});

var _SSTBtn = __webpack_require__(364);

Object.defineProperty(exports, 'SSTBtn', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_SSTBtn).default;
  }
});

var _AutoBtn = __webpack_require__(365);

Object.defineProperty(exports, 'AutoBtn', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_AutoBtn).default;
  }
});

var _GambleBtn = __webpack_require__(366);
...
var _MaxBetBtn = __webpack_require__(367);

Object.defineProperty(exports, 'MaxBetBtn', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_MaxBetBtn).default;
  }
});

var _LanguageBtn = __webpack_require__(368);

Object.defineProperty(exports, 'LanguageBtn', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_LanguageBtn).default;
  }
});
...
var ButtonWithNumber = function (_Button) {
    _inherits(ButtonWithNumber, _Button);

    function ButtonWithNumber(props) {
        _classCallCheck(this, ButtonWithNumber);

        var _this = _possibleConstructorReturn(this, (ButtonWithNumber.__proto__ || Object.getPrototypeOf(ButtonWithNumber)).call(this, props));
...
var _MultipleStatesButton2 = __webpack_require__(65);

var _MultipleStatesButton3 = _interopRequireDefault(_MultipleStatesButton2);
...
var SSTBtn = function (_MultipleStatesButton) {
    _inherits(SSTBtn, _MultipleStatesButton);

    function SSTBtn(props) {
        _classCallCheck(this, SSTBtn);

        var _this = _possibleConstructorReturn(this, (SSTBtn.__proto__ || Object.getPrototypeOf(SSTBtn)).call(this, props));
    ...
    return SSTBtn;
}(_MultipleStatesButton3.default);
...
var AutoBtn = function (_Button) {
    _inherits(AutoBtn, _Button);

    function AutoBtn(props) {
        _classCallCheck(this, AutoBtn);

        var _this = _possibleConstructorReturn(this, (AutoBtn.__proto__ || Object.getPrototypeOf(AutoBtn)).call(this, props));
...
var GambleBtn = function (_MultipleStatesButton) {
    _inherits(GambleBtn, _MultipleStatesButton);
...
var MaxBetBtn = function (_MultipleStatesButton) {
    _inherits(MaxBetBtn, _MultipleStatesButton);

    function MaxBetBtn(props) {
        _classCallCheck(this, MaxBetBtn);

        var _this = _possibleConstructorReturn(this, (MaxBetBtn.__proto__ || Object.getPrototypeOf(MaxBetBtn)).call(this, props));
...
var LanguageBtn = function (_Button) {
    _inherits(LanguageBtn, _Button);

    function LanguageBtn(props) {
        _classCallCheck(this, LanguageBtn);

        // FIXME: Set language dynamically from cookies
        var _this = _possibleConstructorReturn(this, (LanguageBtn.__proto__ || Object.getPrototypeOf(LanguageBtn)).call(this, props));

        _this.setBg('en');
        return _this;
    }

    _createClass(LanguageBtn, [{
        key: "setBg",
        value: function setBg(countryName) {
...
var _ToggleBlock2 = __webpack_require__(133);

var _ToggleBlock3 = _interopRequireDefault(_ToggleBlock2);
...
var ToggleLanguageBlock = function (_ToggleBlock) {
    _inherits(ToggleLanguageBlock, _ToggleBlock);

    function ToggleLanguageBlock(options, props) {
        _classCallCheck(this, ToggleLanguageBlock);

        return _possibleConstructorReturn(this, (ToggleLanguageBlock.__proto__ || Object.getPrototypeOf(ToggleLanguageBlock)).call(this, options, props));
    }

    _createClass(ToggleLanguageBlock, [{
        key: 'init',
        value: function init(options) {
            var _this2 = this;
    ...
    return ToggleLanguageBlock;
}(_ToggleBlock3.default);

exports.default = ToggleLanguageBlock;
...
var _GambleModalButton2 = _interopRequireDefault(_GambleModalButton);

var _stringHelper = __webpack_require__(372);

var _gamble = __webpack_require__(373);
...
var GambleModal = function () {
    function GambleModal(props) {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 3:
                                ...
                                _this.bigCardNode = _this.node.querySelector('#suit' + (0, _stringHelper.capitalize)(gambleResponse.rand_card));
                                // Show randomed card in big card and add to previous cards
                                _this.showDroppedCard(gambleResponse.rand_card);
                                ...
                                if (gambleResponse.won) {
                                    ...
                                    setTimeout(function () {
                                        ...
                                        _this.setValues(gambleResponse.won_coins);
        ...
        var redOverlayColor = 'rgba(255,0,0,0.3)';
    ...
    _createClass(GambleModal, [{
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                return _context2.abrupt('return', _gamble.gambleWin);
                            ...
                            case 7:
                                gambleResponse = _context2.sent;
                                return _context2.abrupt('return', gambleResponse.data);
        ...
        key: 'showDroppedCard',
        value: function showDroppedCard(randomSuit) {
        ...
        key: 'hideDroppedCard',
        value: function hideDroppedCard() {
         ...
         */
        value: function start(currentWin) {
        ...
        key: 'setValues',
        value: function setValues(points) {
...
var gambleLose = exports.gambleLose = { "won": false, "won_coins": 0, "rand_card": "heart" };
var gambleWin = exports.gambleWin = { "won": true, "won_coins": 82, "rand_card": "club" };
...
var defaults = __webpack_require__(94);
var utils = __webpack_require__(18);
var InterceptorManager = __webpack_require__(385);
var dispatchRequest = __webpack_require__(386);
...
var utils = __webpack_require__(18);
var transformData = __webpack_require__(387);
